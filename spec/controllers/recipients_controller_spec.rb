  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved recipient as @recipient" do
        ...
        post :create, {:recipient => { "email" => "invalid value" }}, valid_session
        assigns(:recipient).should be_a_new(Recipient)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested recipient" do
        ...
        Recipient.any_instance.should_receive(:update_attributes).with({ "email" => "MyString" })
        put :update, {:id => recipient.to_param, :recipient => { "email" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the recipient as @recipient" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Recipient.any_instance.stub(:save).and_return(false)
        put :update, {:id => recipient.to_param, :recipient => { "email" => "invalid value" }}, valid_session
        assigns(:recipient).should eq(recipient)
      end
