  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved distribution as @distribution" do
        ...
        post :create, {:distribution => { "title" => "invalid value" }}, valid_session
        assigns(:distribution).should be_a_new(Distribution)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested distribution" do
        ...
        Distribution.any_instance.should_receive(:update_attributes).with({ "title" => "MyString" })
        put :update, {:id => distribution.to_param, :distribution => { "title" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the distribution as @distribution" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Distribution.any_instance.stub(:save).and_return(false)
        put :update, {:id => distribution.to_param, :distribution => { "title" => "invalid value" }}, valid_session
        assigns(:distribution).should eq(distribution)
      end
